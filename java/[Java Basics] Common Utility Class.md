...
- `java.text.SimpleDateFormat;`
    ...
    - String type convert to Date type
        ...
        ```
- `java.util.Calendar;`
    - use Singleton Pattern to get object of Calendar
        ```java
        ...
        ```
    - The `add()` method adds years / months / days based on the original date
    - The `set()` method directly sets the specified year, month and day
        ```java 
        import java.text.SimpleDateFormat;
        import java.util.Calendar;
        import java.util.Date;
